...
Ember.TEMPLATES["category"] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data
    ...
    function program1(depth0, data) {
        ...
        var options;
        data.buffer.push("\n    ");
        data.buffer.push(escapeExpression((helper = helpers['single-post'] || (depth0 && depth0['single-post']), options = {
            hash: {
                'content': ("")
            },
            hashTypes: {
            ...
            types: [],
            data: data
        }, helper ? helper.call(depth0, options) : helperMissing.call(depth0, "single-post", options))));
        data.buffer.push("\n  ");
        return buffer;
    }

    data.buffer.push("<h2>");
    stack1 = helpers._triageMustache.call(depth0, "term.count", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        contexts: [depth0],
    ...
    stack1 = helpers._triageMustache.call(depth0, "term.name", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        contexts: [depth0],
...
Ember.TEMPLATES["user"] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data
    ...
    stack1 = helpers._triageMustache.call(depth0, "author.name", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        contexts: [depth0],
...
Ember.TEMPLATES["components/single-post"] = Ember.Handlebars.template(function anonymous(Handlebars, depth0, helpers, partials, data
    ...
    function program5(depth0, data) {
        ...
        var stack1;
        data.buffer.push("\n      <div class=\"tax-tags\">\n        <p>\n         Tagged\n          <ul>\n            ");
        stack1 = helpers.each.call(depth0, "tags", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: self.noop,
    ...
    function program6(depth0, data) {
        ...
        stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']), options = {
            ...
            types: ["STRING", "ID"],
            data: data
        }, helper ? helper.call(depth0, "tag", "slug", options) : helperMissing.call(depth0, "link-to", "tag", "slug", options));
        if (stack1 || stack1 === 0) {
            data.buffer.push(stack1);
        }
        data.buffer.push("</li>\n           ");
    ...
    function program9(depth0, data) {
        ...
        var stack1;
        data.buffer.push("\n      <div class=\"tax-cats\">\n        Categories:\n       <ul>\n          ");
        stack1 = helpers.each.call(depth0, "categories", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            inverse: self.noop,
    ...
    function program10(depth0, data) {
        ...
        stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']), options = {
            ...
            types: ["STRING", "ID"],
            data: data
        }, helper ? helper.call(depth0, "category", "slug", options) : helperMissing.call(depth0, "link-to", "category", "slug", options));
        if (stack1 || stack1 === 0) {
            data.buffer.push(stack1);
        }
        data.buffer.push("</li>\n         ");
    ...
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']), options = {
        ...
        types: ["ID", "ID"],
        data: data
    }, helper ? helper.call(depth0, "type", "slug", options) : helperMissing.call(depth0, "link-to", "type", "slug", options));
    if (stack1 || stack1 === 0) {
        data.buffer.push(stack1);
    }
    data.buffer.push("\n    </h1>\n   <time class=\"published\">");
    stack1 = helpers._triageMustache.call(depth0, "date", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        contexts: [depth0],
    ...
    stack1 = (helper = helpers['link-to'] || (depth0 && depth0['link-to']), options = {
        ...
        types: ["STRING", "ID"],
        data: data
    }, helper ? helper.call(depth0, "user", "author.slug", options) : helperMissing.call(depth0, "link-to", "user", "author.slug", options));
    if (stack1 || stack1 === 0) {
        data.buffer.push(stack1);
    }
    data.buffer.push("</p>\n  </header>\n <div class=\"entry-content\">");
    data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "content", {
        hash: {
            'unescaped': ("true")
        },
        hashTypes: {
    ...
    stack1 = helpers['if'].call(depth0, "tags", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        inverse: self.noop,
    ...
    data.buffer.push("\n    ");
    stack1 = helpers['if'].call(depth0, "categories", {
        hash: {},
        hashTypes: {},
        hashContexts: {},
        inverse: self.noop,

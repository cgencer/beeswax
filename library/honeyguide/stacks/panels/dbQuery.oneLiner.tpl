...
<div class="row" style="padding:4px;">
	<div class="col-md-8">
			...
			<div class="input-group-btn">
				<span class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dMenu1">
						{{#left}}
						<li><a href="#">{{item.label}}{{#item.required}} (*){{/item.required}}</a></li>
						{{/left}}
					...
					<button type="button" class="btn btn-default dropdown-toggle" id="dMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action <span class="caret"></span></button>
		...
		<div class="col-md-4 text-right pull-right">
			...
			<a id="addLiner" class="btn btn-primary oneLinerButton">+</a>
		</div>
	</div>
</div>